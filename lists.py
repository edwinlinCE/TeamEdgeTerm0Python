...
lists_of_lists = [random_strings, numbers, friends]
...
favorite_songs = ["Lost me", "Empire State of Mind", "Jimmy Cooks", "Love is only a feeling", "Going Bad"]
#-->TODO: Add 2-3 more songs using .append() and print both before and after.
favorite_songs.append("327")
favorite_songs.append("Friday")
...
print(f"I have {len(favorite_songs)} favorite songs!")
...
if len(favorite_songs) >= 5:
    ...
    favorite_songs.append("cool song1")
    favorite_songs.append("cool song2")
...
rejoin = split_me + make_me_exciting
print(rejoin)